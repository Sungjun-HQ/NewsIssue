...
public class MyCustListAdapter extends BaseAdapter {

	Context context;
	LayoutInflater Inflater;
	ArrayList<NewsItem> news_list;
	int layout;

	public MyCustListAdapter(Context context, int layout,
			ArrayList<NewsItem> news_list) {
	...
	public ArrayList<NewsItem> getNews_list() {
		return news_list;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		NewsItem m = news_list.get(position);
		ViewHolder holder;
		if (convertView == null) {
