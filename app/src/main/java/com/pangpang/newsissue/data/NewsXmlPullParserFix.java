...
public class NewsXmlPullParserFix extends
		AsyncTask<String, String, ArrayList<NewsItemFix>> {

	private InputStream isText = null;
	private NewsItemFix mNewsItem;
	private HashMap<String, String> newsMap;
	private ArrayList<NewsItemFix> news_list = new ArrayList<NewsItemFix>();
	...
	@Override
	protected ArrayList<NewsItemFix> doInBackground(String... params) {
		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				...
				case XmlPullParser.END_TAG:
					...
					if (nTag.compareTo("item") == 0) {
						check_item = false;
						mNewsItem = new NewsItemFix(newsMap);
	...
	@Override
	protected void onPostExecute(ArrayList<NewsItemFix> result) {
