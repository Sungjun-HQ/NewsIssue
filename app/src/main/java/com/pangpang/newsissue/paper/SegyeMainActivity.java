...
public class SegyeMainActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.title_recent); // 최신기사
			case 1:
				return getString(R.string.title_totals); // 종합
			case 2:
			...
			case 9:
				return getString(R.string.title_peoples); // 피플
			case 10:
