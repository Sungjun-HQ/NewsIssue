...
public class HankyorehMainActivity extends FragmentActivity implements
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				nm9 = new NewsMainFragment(mContext,
						"http://www.hani.co.kr/rss/opinion/");
				nm10 = new NewsMainFragment(mContext,
						"http://www.hani.co.kr/rss/cartoon/");
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			case 5:
				return getString(R.string.title_culture4);
			case 6:
				return getString(R.string.title_sports);
			case 7:
				return getString(R.string.title_science4);
			case 8:
				return getString(R.string.title_editorials);
			case 9:
				return getString(R.string.title_cartoon);
			case 10:
				return getString(R.string.title_lead);
			case 11:
				return getString(R.string.title_newsrank);
			}
			return null;
		}
	}
