...
public class HankookMainActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			case 5:
				return getString(R.string.title_lifenews);
			case 6:
				return getString(R.string.title_international);
			case 7:
				return getString(R.string.title_it);
			case 8:
			...
			case 13:
				return getString(R.string.title_tv);
			}
			return null;
		}
	}
