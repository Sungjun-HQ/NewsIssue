...
public class DongAMainActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			case 6:
				return getString(R.string.title_science1);
			case 7:
				return getString(R.string.title_culture1);
			case 8:
				return getString(R.string.title_sports);
			case 9:
				return getString(R.string.title_inmul);
			}
			return null;
		}
	}
