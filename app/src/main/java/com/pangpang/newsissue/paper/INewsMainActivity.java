...
public class INewsMainActivity extends FragmentActivity implements
		...
		new Thread(new Runnable() {
			...
			public void run() {
				nm1 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_all.xml");
				nm2 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_it.xml");
				nm3 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_economy.xml");
				nm4 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_politics.xml");
				nm5 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_society.xml");
				nm6 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_culture.xml");
				nm7 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_life.xml");
				nm8 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_enter.xml");
				nm9 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_sports.xml");
				nm10 = new NewsMainFragment(mContext,
						"http://www.inews24.com/rss/news_game.xml");
			}
		}).start();
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			case 6:
				return getString(R.string.title_life); // 생활
			case 7:
